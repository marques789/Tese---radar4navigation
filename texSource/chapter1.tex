...
\section{Objectives}
%For this dissertation there are multiple objectives to take in mind. 
...
%First, a study of how \ac{LiDAR} and the \ac{FMCW} \ac{radar} technology must be conducted in order to understand where they are used and how they work as well as their limitations. After that we must uncover how we can create a suitable robotic platform using \ac{ROS}  and state of the art algorithms to resolve the navigation problems. Moving forward, we want to choose  specific devices and describe what characteristics they have in order to create a suitable navigation platform for our work.
