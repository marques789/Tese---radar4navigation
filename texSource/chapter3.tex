...
\begin{itemize}
    ...
    \item \textbf{rqt_graph} - To understand how the various nodes and topics are interconnected the use of rqt\_graph is the best for this case. It can be used to produce an image of all of them and how they communicate between each other
